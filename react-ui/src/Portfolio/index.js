	...
	return (
		<>
			<div
				...
				<p className="whitespace-pre-line mt-4">
					HTML, CSS, JS building small ,
					medium web and large scale web
					apps with REACTJS, custom
	...
	return (
		<>
			<div
				...
				<p className="whitespace-pre-line mt-4">
					Well-organised person, problem
					solver, independent employee
					with high attention to detail.
					Fan of MMA, outdoor
					activities, TV series and,
					recently, English literature.
					A family person, father of two
					fractious boys, therefore
					remote employment is
					preferred.
				</p>
				<p className="whitespace-pre-line mt-4">
					Interested in the entire
					frontend spectrum and working
					on ambitious projects with
					positive people.
				</p>
			</div>
		</>
	...
	return (
		<div
			...
			<animated.a
				...
				className="inline-block mt-8 px-4 py-2 border text-blue-400 border-blue-400 hover:bg-blue-400 hover:text-white">
				CONTACT ME
			</animated.a>
			<div>
				<animated.div
				...
				<form
					...
					<div
						...
						<animated.button
							...
							class="mt-2 px-6 py-1  bg-blue-400 text-white font-bold">
							Send
						</animated.button>
					</div>
				</form>
				...
				<animated.div
					...
					<div className="relative cursor-pointer rounded-lg  overflow-hidden">
						<animated.div
							...
							class="absolute z-10 top-0 right-0 font-bold  h-full flex justify-center items-center text-white"></animated.div>
